...
<div class="container">
	<div class="span12" style="margin-top:1%;margin-left:14%">
		...
		<div class="span4 offset5" style="margin-top:0.7%">
			<a href="#"><img src="img/sign.png" width="120px"/></a>
			<a href="#"><img src="img/login.png" width="120px" /></a>
	    </div>
	</div>
	<div class="span12" style="margin-top:1%;margin-left:10%;background-image:url(img/banner1.png);height:435px;width:1200px">
		<form>
			...
			<a href="javascript:form1.submit();">
				<img src="img/submit.png" border="0" style="margin-top:12.8%;margin-left:0.4%;width55px;height:45px;" >
			</a>
		</form>
	</div>
	<div class="span12 row-fluid" style="margin-top:2%;margin-left:14%;white-space:nowrap">
		...
		<div class="span10">
			<a><img src="img/sina.png" width="50px" height="50px" style="margin-left:70%"></a>
			<a><img src="img/QQ.png" width="50px" height="50px"></a>
			<a><img src="img/renren.png" width="50px" height="50px"></a>
		</div>
	</div>		
</div>
